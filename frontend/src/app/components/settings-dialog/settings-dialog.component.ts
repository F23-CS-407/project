...
export class SettingsDialogComponent {
  ...
  signOut() {
    ...
    this.http.delete(this.backend_addr + '/logout', { withCredentials: true }).subscribe(
      response => {
  ...
  deleteAccount() {
    ...
    if (password) {
      ...
      this.http.request('delete', this.backend_addr + '/delete_user', { body: body, headers: headers, withCredentials: true }).subscribe(
        response => {
